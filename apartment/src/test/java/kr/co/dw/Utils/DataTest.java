...
public class DataTest {
	...
	//	String a = ReGion.SEOUL.get("SEOUL").get(0).get("11110");
	...
	void test() {
		String[][] KoreaRegionCode = {
		 ...
		 String[][] RegionCode = {
				...
				/*제주도*/
				{ "50110", "50130" } }; //2
		List<Region> list = RegionManager.JEJU;
		int index = 16;
		for(int i = 0 ; i< list.size() ; i++) {
			if(!list.get(i).getRegionName().equals(KoreaRegionCode[index][i])) {
			
				System.out.println(list.get(i).getRegionName());
				System.out.println(KoreaRegionCode[index][i]);
				throw new RuntimeException();
			}
			System.out.println(list.get(i).getRegionName().equals(KoreaRegionCode[index][i]));
		}
